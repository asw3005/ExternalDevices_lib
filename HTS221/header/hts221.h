 ...
 **/
#define HTS221_ADDR_SHIFTED             0xBE                                //7 bit MSB 0x76 (address) + 1 bit LSB 0x00 (read/write)
#define HTS221_ADDR						0x5F								//It's not shifted address
...
#define HTS221_ADDR_AUTOINC_ENABLE				0x80
...
typedef enum 
{
	...
	///Status register
	HTS221_STATUS_REG		= 0x27 | HTS221_ADDR_AUTOINC_ENABLE,
	///Humidity output registers
	HTS221_HUMIDITY_OUT_L	= 0x28 | HTS221_ADDR_AUTOINC_ENABLE,
	HTS221_HUMIDITY_OUT_H	= 0x29,
	///Temperature output registers
	HTS221_TEMP_OUT_L		= 0x2A | HTS221_ADDR_AUTOINC_ENABLE,
	HTS221_TEMP_OUT_H		= 0x2B,
	///Calibration data registers, DON'T MODIFY, range 0x30 - 0x3F
	HTS221_CALIB_START		= 0x30 | HTS221_ADDR_AUTOINC_ENABLE,
	HTS221_CALIB_STOP		= 0x3F,
...
typedef enum 
{
	...
	HTS221_PP_OD_PUSH_PULL = 0,
	HTS221_PP_OD_OPEN_DRAIN = 1,
	///Data Ready output signal active high, low, 0: active high - default, 1: active low.
	HTS221_DRDY_H_L_ACTIVE_HIGH = 0,
	HTS221_DRDY_H_L_ACTIVE_LOW = 1,
