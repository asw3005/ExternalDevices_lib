 ...
 **/
static int32_t HTU21D_TemperatureConv(HTU21D_typedef *dev_htu21d); 
static uint32_t HTU21D_HumidityConv(HTU21D_typedef *dev_htu21d);  
...
{	
	...
	dev_htu21d->delay(15);
	dev_htu21d->dev_compensated_data.TemperatureC = HTU21D_TemperatureConv(dev_htu21d) / 10;
