 ...
 *
 **/
#define ADDR_STROBE_PIN_PORT	GPIOB
#define RW_PIN_PORT				GPIOD
#define DS_PIN_PORT				GPIOD
...
#define ADDRESS_STROBE_PIN  GPIO_PIN_7
...
#define READ_WRITE_PIN		GPIO_PIN_5
...
#define DATA_STROBE_PIN		GPIO_PIN_4
...
/*
 * @brief Hardware dependent function.
 *
 **/
