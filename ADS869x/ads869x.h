/*
 * @brief Common header for ADS8691, ADS8695, ADS9699 from the Texas Instruments.
...
/* GPIO configuration. */
#define ADS869x_CS_ADC_Pin							GPIO_PIN_12
#define ADS869x_CS_ADC_GPIO_Port					GPIOB
#define ADS869x_RST_ADC_Pin							GPIO_PIN_6
#define ADS869x_RST_ADC_GPIO_Port					GPIOC

/* ADC constants. */
#define ADS869x_WKEY								0x69
/* Select your scale. */
/* Positive scale. */
#define ADS869x_VALUE_OF_DIVISION_5_12P				0.00001953f
#define ADS869x_VALUE_OF_DIVISION_6_144P			0.00002343f
#define ADS869x_VALUE_OF_DIVISION_10_24P			0.00003906f
#define ADS869x_VALUE_OF_DIVISION_12_288P			0.000046875f
/* Positive + Negative scale. */
#define ADS869x_VALUE_OF_DIVISION_2_56P_2_56N		0.00001953f
#define ADS869x_VALUE_OF_DIVISION_5_12P_5_122N		0.00003906f
#define ADS869x_VALUE_OF_DIVISION_6_144P_6_144N		0.000046875f
#define ADS869x_VALUE_OF_DIVISION_10_24P_10_24N		0.000078125f
#define ADS869x_VALUE_OF_DIVISION_12_288P_12_288N	0.00009375f
...
typedef enum {
	...
	ADS869x_DEVICE_ID_LSW,
	ADS869x_DEVICE_ID_HSW		= 0x02,
...
typedef enum {
	...
	ADS869x_CPOL0_CPHASE0,
	ADS869x_CPOL0_CPHASE1,
	ADS869x_CPOL1_CPHASE0,
	ADS869x_CPOL1_CPHASE1
...
typedef enum {
	...
	ADS869x_SDO1_TRISTATE,
	ADS869x_SDO1_ALARM,
	ADS869x_SDO1_GPO,
	ADS869x_SDO1_2BITMODE
...
typedef enum {
	...
	ADS869x_ALLZERO		= 4,
	ADS869x_ALLONES,
	ADS869x_ALTERNATING_0_1,
	ADS869x_ALTERNATING_00_11
...
typedef enum {
	...
	ADS869x_ACTIVE_IN_DO_NOT_INCL,
	ADS869x_ACTIVE_IN_H_FLAG_INCL,
	ADS869x_ACTIVE_IN_L_FLAG_INCL,
	ADS869x_BOTH_ACTIVE_IN_FLAGS_INCL
	
} ADS869x_InActiveAlarm;
...
typedef enum {
	...
	ADS869x_ACTIVE_VDD_DO_NOT_INCL,
	ADS869x_ACTIVE_VDD_H_FLAG_INCL,
	ADS869x_ACTIVE_VDD_L_FLAG_INCL,
	ADS869x_BOTH_ACTIVE_VDD_FLAGS_INCL
	
} ADS869x_VddActiveAlarm;
...
typedef union __attribute__((aligned(1), packed)) {
	...
	struct {
		uint32_t PARITY_BITS		: 2;
		uint32_t ADC_INPUT_RANGE	: 4;
		uint32_t INPUT_ALARM_FLAGS	: 2;
		uint32_t AVDD_ALARM_FLAGS	: 2;
...
typedef struct {
	...
	ADS869x_GInst_t ADC0Struct;
	ADS869x_GInst_t ADC1Struct;
