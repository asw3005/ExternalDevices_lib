...
/* GPIO configuration. */
#define ADS867x_CS_ADC_Pin							GPIO_PIN_12
#define ADS867x_CS_ADC_GPIO_Port					GPIOB
#define ADS867x_RST_ADC_Pin							GPIO_PIN_6
#define ADS867x_RST_ADC_GPIO_Port 					GPIOC

/* ADC constants. */
#define ADS867x_WKEY								0x69
/* Select your scale. */
/* Positive scale. */
#define ADS867x_VALUE_OF_DIVISION_5_12P				0.312f
#define ADS867x_VALUE_OF_DIVISION_6_144P			0.375f
#define ADS867x_VALUE_OF_DIVISION_10_24P			0.625f
#define ADS867x_VALUE_OF_DIVISION_12_288P			0.75f
/* Positive + Negative scale. */
#define ADS867x_VALUE_OF_DIVISION_2_56P_2_56N		0.312f
#define ADS867x_VALUE_OF_DIVISION_5_12P_5_122N		0.625f
#define ADS867x_VALUE_OF_DIVISION_6_144P_6_144N		0.75f
#define ADS867x_VALUE_OF_DIVISION_10_24P_10_24N		1.25f
#define ADS867x_VALUE_OF_DIVISION_12_288P_12_288N	1.5f
...
void ADS867x_RST(uint8_t state);
float ADS867x_GetVoltage(float scale);
